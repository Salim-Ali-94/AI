...
if __name__ == "__main__":
	...
	episodes = int(1e3)
	learning_rate = 5e-2
	encoding = [("setosa", 0), ("versicolor", 1), ("virginica", 0.5)]
	...
	network.plot(error, "forestgreen", "accumulated_error_over_each_epoch_multiclass_classification", "Episode", "Error")
	network.plot(accuracy, "mediumvioletred", "accuracy_over_each_epoch_multiclass_classification", "Episode", "Learning accuracy")
